...
export function Navbar() {
  ...
  return (
    ...
    <nav
      ref={menuRef}
      className="w-full fixed top-0 left-0 right-0 z-50 bg-blue-600 text- shadow-md" 
    >
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1 text-white hover:text-blue-400 px-3 py-2 rounded transition-colors duration-200 focus:outline-none"
              >
                Nepal <ChevronDown className="w-4 h-4" />
              </button>
              {activeMenu === "nepal" && (
                <div className="absolute top-full mt-2 bg-white text-black shadow-xl rounded-md overflow-hidden" style={{width: '800px', left: '-300px'}}>
                  <div className="flex">
                    {/* Left Sidebar */}
            ...
            <div className="relative">
              ...
              {activeMenu === "about" && (
                <div className="absolute top-full mt-2 bg-white text-black shadow-xl rounded-md overflow-hidden" style={{width: '500px', left: '-200px'}}>
                  <div className="flex">
                    {/* Left Column */}
            ...
            <Link
              href="/contact"
              className="text-white hover:text-blue-400 px-3 py-2 rounded transition-colors duration-200"
            >
              Contact Us
            </Link>
          </div>
